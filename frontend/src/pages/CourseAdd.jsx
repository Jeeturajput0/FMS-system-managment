    ...
    apiFetch(`/api/courses/${id}`)
      .then(({ data }) =>
        setForm({
          ...emptyForm,
          ...data,
          duration: data.duration?.value || 4,
        ...
        <div className="mb-8 flex items-center gap-3 border-b border-slate-100 pb-5">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">
              Course details are stored directly in MongoDB.
            </p>
          </div>
        </div>
        {error && (
        ...
        <form onSubmit={submit} className="grid gap-5 sm:grid-cols-2">
          <label className="sm:col-span-2 text-sm font-semibold text-slate-700">
            ...
            <input
              ...
              className="mt-1 w-full rounded-xl border border-slate-200 p-3 font-normal outline-none focus:border-orange-500"
            />
          </label>
          <label className="sm:col-span-2 text-sm font-semibold text-slate-700">
            Description
          ...
          <label className="sm:col-span-2 text-sm font-semibold text-slate-700">
            ...
            <input
              ...
              multiple
              onChange={(e) =>
                update("images", Array.from(e.target.files || []))
              }
          ...
          <button
            disabled={saving}
            className="sm:col-span-2 inline-flex items-center justify-center gap-2 rounded-xl bg-orange-500 px-5 py-3 font-bold text-white hover:bg-orange-600 disabled:opacity-60"
          >
