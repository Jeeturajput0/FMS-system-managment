...
import AddTeacherPage from "./feature/franchise/pages/AddTeacherPage";
      ...
      document.querySelectorAll("table").forEach((table) => {
        ...
        Array.from(table.tBodies)
          ...
          .forEach((row) => {
            ...
            const isEmptyState =
              cells.length === 1 && Number(cells[0].colSpan) > 1;

            row.toggleAttribute("data-mobile-empty", isEmptyState);
            cells.forEach((cell, index) => {
              cell.dataset.label = isEmptyState
                ? ""
                : headings[index] || "Details";
            });
          });
      });
    };
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        {/* Admin Registration */}
        <Route path="/register/admin" element={<LoginPage isRegister />} />
        ...
        <Route path="/admin" element={<ProtectedAdminRoute />}>
          ...
          <Route path="franchises/Timetable" element={<FranchiseBatches />} />
        ...
        >
          ...
          <Route
            path="courses/:courseId/modules/:moduleId/topics"
            element={<PortalModuleTopics />}
          />
          <Route
            path="courses/:courseId/modules/:moduleId/topics/:topicId"
            element={<PortalTopicDetail />}
          />
...
/>
          ...
          <Route path="batches/timetable" element={<FranchiseSchedule />} />
          <Route
            path="schedule"
            element={<Navigate to="/franchise/batches/timetable" replace />}
          />
