...
export default function CourseModules() {
  ...
  const filteredModules = modules.filter((module) => {
    ...
    const courseTitle = module.courseId?.title?.toLowerCase() || "";
  ...
  const handleDelete = async (moduleId) => {
    ...
    try {
      ...
      setModules((prev) =>
        prev.filter((item) => item._id !== moduleId)
      );
  ...
  const handlePublish = async (moduleId) => {
    try {
      ...
      setModules((prev) =>
        prev.map((item) =>
          item._id === moduleId ? data.data : item
        )
      );
    } catch (publishError) {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-xs text-slate-600">
                Select existing standalone modules to attach to this
                course.
              </p>
            </div>
      ...
      {/* MODULE HEADER + SEARCH + COURSE FILTER */}
          ...
          <div className="flex w-full flex-col gap-3 sm:flex-row lg:w-auto">
            ...
            <div className="relative w-full sm:w-72">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pl-9 pr-9 text-xs font-semibold text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-orange-400 focus:bg-white focus:ring-2 focus:ring-orange-100"
              />
            ...
            {!courseId && (
              <select
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-xs font-semibold text-slate-700 outline-none focus:border-orange-400 sm:w-64"
              >
                    ...
                    >
                      ...
                      <td className="px-5 py-4">
                        <div className="flex justify-end gap-2">
                          <Link
                            to={`/admin/topics/add?moduleId=${moduleId}${
                              module.courseId?._id
