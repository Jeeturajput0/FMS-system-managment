    ...
    <div className="mx-auto max-w-6xl space-y-5">
      ...
      <div className="rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white shadow-lg">
        ...
        <div className="mt-5 grid gap-2 text-xs text-blue-50 sm:grid-cols-2 lg:grid-cols-4">
          <span className="rounded-lg bg-white/10 px-3 py-2">Teacher: {teacherName}</span>
          <span className="rounded-lg bg-white/10 px-3 py-2">Schedule: {schedule}</span>
          <span className="rounded-lg bg-white/10 px-3 py-2">Days: {days}</span>
          <span className="rounded-lg bg-white/10 px-3 py-2">Capacity: {batch.students?.length || 0}/{batch.maxStudents || 0}</span>
        </div>
      </div>
  ...
  >
    <div className="min-w-0">
      ...
      <p className="mt-1 text-xs text-slate-500">
        Students already assigned to this batch are hidden. Select multiple students at once.
      </p>
    </div>
    ...
    <div className="animate-in fade-in slide-in-from-top-2 duration-200">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 bg-slate-50/60 px-4 py-3">
        ...
        <span className="text-xs font-semibold text-slate-500">
          {selectedIds.length} selected · {unassignedStudents.length} available
        </span>
      </div>
